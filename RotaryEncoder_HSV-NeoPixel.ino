...
uint8_t xH = 19;  // selection bullets
uint8_t xS = 64;  // corresponding to
uint8_t xV = 105; // each item
...
void loop() {
  ...
  if (encoderPosCheck != encoderPos)
  {
    ...
    tft.fillRect(14,0,23,80, BLACK);
    tft.fillRect(14,5+(70-yh),23,4,WHITE); // slider bar
    tft.fillRect(20,6+(70-yh),11,2,BLACK);
    ...
    tft.drawRect(xs,ySV,18,75, WHITE); // outline rectangle
    
    //tft.fillRect(x,y,w,h,t)
    tft.fillRect(xs+3,ySV+2,12,72,WHITE); // solid white
  
    tft.fillRect(xs+3,ySV+2,12,64-ys,BLACK); // black curtain that 
                                            // changes with the variable
    // this gives the impression that the white rectangle changes ;•)
    tft.drawRect(xs+1,ySV+67,16,3,BLACK);
    tft.drawRect(xs+1,ySV+71,16,3,BLACK);
    ...
    uint8_t xv = 102;
    //tft.drawRect(x,y,w,h,t)
    tft.drawRect(xv,ySV,18,75, WHITE); // outline rectangle
    
    //tft.fillRect(x,y,w,h,t)
    tft.fillRect(xv+3,ySV+2,12,72,WHITE); 
  
    tft.fillRect(xv+3,ySV+2,12,64-yv,BLACK);  // black curtain that 
                                            // changes with the variable
    tft.drawRect(xv+1,ySV+67,16,3,BLACK);
    tft.drawRect(xv+1,ySV+71,16,3,BLACK);
  }
...
void satIcon() // colour-block
{
  ...
  tft.fillRect(x,y+h,w,h, GREEN);
  tft.fillRect(x,y+(2*h),w,h, BLUE);
  tft.fillRect(x,y+(3*h),w,h, YELLOW);
  tft.fillRect(x+w,y,w,h, paleMAGENTA);
  tft.fillRect(x+w,y+h,w,h, paleGREEN);
  tft.fillRect(x+w,y+(2*h),w,h, paleBLUE);
  tft.fillRect(x+w,y+(3*h),w,h, paleYELLOW);
...
void rainbowSlider() // rainbow bar
{
      //tft.drawFastVLine(x,y,h,t)
    tft.drawFastVLine(24,10,10, MAGENTA);
    tft.drawFastVLine(24,20,10, BLUE);
    tft.drawFastVLine(24,30,10, CYAN);
    tft.drawFastVLine(24,40,10, GREEN);
    tft.drawFastVLine(24,50,10, YELLOW);
    tft.drawFastVLine(24,60,10, ORANGE);
    tft.drawFastVLine(24,70,10, RED);
    
    tft.drawFastVLine(25,10,12, MAGENTA);
    tft.drawFastVLine(25,20,10, BLUE);
    tft.drawFastVLine(25,30,10, CYAN);
    tft.drawFastVLine(25,40,10, GREEN);
    tft.drawFastVLine(25,50,10, YELLOW);
    tft.drawFastVLine(25,60,10, ORANGE);
    tft.drawFastVLine(25,70,10, RED);

    tft.drawFastVLine(26,10,10, MAGENTA);
    tft.drawFastVLine(26,20,10, BLUE);
    tft.drawFastVLine(26,30,10, CYAN);
    tft.drawFastVLine(26,40,10, GREEN);
    tft.drawFastVLine(26,50,10, YELLOW);
    tft.drawFastVLine(26,60,10, ORANGE);
    tft.drawFastVLine(26,70,10, RED);
}
